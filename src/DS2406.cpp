...
void DS2406::clearMemory(void)
{
    memset(memory, static_cast<uint8_t>(0x00), sizeof(memory));
}

void DS2406::clearScratchpad(void)
{
    memset(scratchpad, static_cast<uint8_t>(0x00), SCRATCHPAD_SIZE);
}

bool DS2406::writeMemory(const uint8_t* const source, const uint8_t length, const uint8_t position)
{
...
bool DS2406::readMemory(uint8_t* const destination, const uint16_t length, const uint16_t position) const
{
...
void DS2406::setPageProtection(const uint8_t position)
{
...
bool DS2406::getPageProtection(const uint8_t position) const
{
...
void DS2406::setPageEpromMode(const uint8_t position)
{
...
bool DS2406::getPageEpromMode(const uint8_t position) const
{
    if      (position < 1*PAGE_SIZE)
    {
...
bool DS2406::updatePageStatus(void)
{
    page_eprom_mode = 0;
    page_protection = 0;
